...
import app.wen.com.okhttpdemo.utils.ImageUtils;

/**
 * Created by wangenning on 16/1/5.
 */
public class HttpManager {
    ...
    public static Response post(String url, StringCallback stringCallback, Param... params) throws IOException {
    ...
    public static void postAsyn(String url, final StringCallback callback, String test, String s, Param... params) {
    ...
    public static void postAsyn1(String url, StringCallback callback, File file, String fileKey) throws IOException {
        getInstance()._postAsyn(url, callback, file, fileKey);
    }


    public static void postAsyn2(String url, StringCallback callback, File file, String fileKey, Param... params) throws IOException {
