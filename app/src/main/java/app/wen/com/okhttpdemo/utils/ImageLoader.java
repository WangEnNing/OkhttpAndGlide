...
public class ImageLoader {
    ...
    private static  BitmapTypeRequest<String> mGlideModelRequest ;
    private static CenterCrop mCenterCrop;

    private static int mPlaceHolderResId = -1;
     ...
     */
    public static void loadImage(String url, ImageView imageView, RequestListener<String, Bitmap> requestListener,
                                 Drawable placeholderOverride, boolean crop) {
        BitmapRequestBuilder request = beginImageLoad(url, requestListener, crop).animate(R.anim.sacle_anim_zoom_in);
    ...
    public static BitmapRequestBuilder beginImageLoad(String url,
     ...
     */
    public static void loadImage(String url, ImageView imageView, boolean crop) {
